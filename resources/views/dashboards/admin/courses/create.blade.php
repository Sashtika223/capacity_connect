...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold">Create Course</h2>
        ...
        <form action="{{ route('admin.courses.store') }}" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="course_code" class="form-control rounded-3 @error('course_code') is-invalid @enderror" value="{{ old('course_code') }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <select name="publish_status" class="form-select rounded-3 @error('publish_status') is-invalid @enderror" required>
                        <option value="draft" {{ old('publish_status') == 'draft' ? 'selected' : '' }}>Draft (Hidden)</option>
                        <option value="published" {{ old('publish_status') == 'published' ? 'selected' : '' }}>Published (Live)</option>
                    </select>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" rows="5" class="form-control rounded-3 @error('description') is-invalid @enderror" required>{{ old('description') }}</textarea>
